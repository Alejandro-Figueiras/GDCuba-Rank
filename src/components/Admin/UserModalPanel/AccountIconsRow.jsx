...
const AccountIconsRow = ({user}) => {
  return (<Card className="bg-default-200">
    <CardBody className="flex justify-evenly flex-row p-4">
      <AccountIcon type={"cube"} iconNumber={user.accicon} c1={user.playercolor} c2={user.playercolor2} c3={user.playercolor3} glow={user.accglow} />
      <AccountIcon type={"ship"} iconNumber={user.accship} c1={user.playercolor} c2={user.playercolor2} c3={user.playercolor3} glow={user.accglow} />
      <AccountIcon type={"ball"} iconNumber={user.accball} c1={user.playercolor} c2={user.playercolor2} c3={user.playercolor3} glow={user.accglow} />
      <AccountIcon type={"ufo"} iconNumber={user.accbird} c1={user.playercolor} c2={user.playercolor2} c3={user.playercolor3} glow={user.accglow} />
