  ...
  return (
    <div className='m-4 flex flex-col text-center justify-center'>
      <div className='container max-w-[800px] mx-auto'>
        ...
        <p className='text-xl font-semibold mb-4'>Fase 2: Bugfix</p>
        <p className='mb-2'>En esta fase su objetivo es romper la página tanto visual como funcionalmente. Cuando encuentren un bug, necesito que lo identifiquen lo mejor que puedan, y si es algo de alguna funcionalidad, que expliquen como provocarlo, en mi caso es mucho más sencillo arreglarlo.</p>
