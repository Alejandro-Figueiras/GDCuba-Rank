...
export default ({ ranking, tipo = 'stars' }) => {
  ...
  if (tipo=='stars') {
    ...
    cols.push(<TableColumn width={100} key={'col_usercoin'}><span className="flex"><img src="/assets/stats/usercoin.png" alt="Coin" className="h-4 mr-1"/> User Coins</span></TableColumn>)
    ...
    cols.push(<TableColumn width={100} key={'col_cp'}><span className="flex"><img src="/assets/stats/creatorpoints.png" alt="CP" className="h-4 mr-1"/> Creator Points</span></TableColumn>)
    ...
    cols.push(<TableColumn width={120} key={'col_cp'}><span className="flex align-middle"><img src="/assets/dificultades/none/extreme_demon.png" alt="CP" className="h-8 mr-1"/> Extreme<br />Demons</span></TableColumn>)
    cells.push((player, i) => <TableCell key={`cell${i}_${player.username}_cp`}><span className="flex align-middle"><img src="/assets/dificultades/none/extreme_demon.png" alt="CP" className="h-5 mr-1"/> {player.verified_extreme_demons}</span></TableCell>)
  }
