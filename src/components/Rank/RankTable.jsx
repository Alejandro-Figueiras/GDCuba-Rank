  ...
  return (
    <Table aria-label="Example table with dynamic content" selectionMode="single">
      <TableHeader>
          ...
          {(tipo == "stars") && <TableColumn width={120}><span className="flex"><img src="/img/star.png" alt="Star" className="h-4 mr-1"/> Estrellas</span></TableColumn>}
      ...
      <TableBody>
        {
          ranking.map((player, i) => 
            <TableRow key={i+1} onClick={() => openUserView(player)}>
              ...
              {(tipo == "stars") && <TableCell><span className="flex align-middle"><img src="/img/star.png" alt="Star" className="h-4 mr-1"/> {player.stars}</span></TableCell>}
